#!/usr/bin/env python3
"""Walk-forward analysis for Donchian Channel Breakout strategy at 1h and 4h."""
...
def main():
    ...
    # Donchian Channel param grid (full grid from strategy)
    grid = {
    ...
    print("DONCHIAN CHANNEL — 1h — Rolling 18mo IS / 3mo OOS", file=sys.stderr)
    print("=" * 80, file=sys.stderr)
    ...
    # --- 4h Walk-Forward ---
    print("=" * 80, file=sys.stderr)
    print("DONCHIAN CHANNEL — 4h — Rolling 18mo IS / 3mo OOS", file=sys.stderr)
    print("=" * 80, file=sys.stderr)
