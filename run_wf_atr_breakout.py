#!/usr/bin/env python3
"""Walk-forward analysis for ATR Breakout strategy at 1h and 4h."""
...
def main():
    ...
    # ATR Breakout param grid (full grid from strategy)
    grid = {
    ...
    print("ATR BREAKOUT — 1h — Rolling 18mo IS / 3mo OOS", file=sys.stderr)
    print("=" * 80, file=sys.stderr)
    ...
    # --- 4h Walk-Forward ---
    print("=" * 80, file=sys.stderr)
    print("ATR BREAKOUT — 4h — Rolling 18mo IS / 3mo OOS", file=sys.stderr)
    print("=" * 80, file=sys.stderr)
